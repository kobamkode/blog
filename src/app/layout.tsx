                ...
                <html lang="en">
                        <body>
                                <header className="container">
                                        <nav>
                                                <ul>
                                                        <li><Link href="/"><strong>KobamKode</strong></Link></li>
                                                </ul>
                                                <ul>
                                                        <li><Link href="/about">About</Link></li>
                                                        <li><Link href="https://github.com/kobamkode" target="_blank">
                                                        ...
                                                        <li><Link href="https://www.linkedin.com/in/mrwbsn/" target="_blank">
                                                        ...
                                                        <li><Link href="https://www.instagram.com/mrwbsn/" target="_blank">
